...
// Usage: replace all previous #00B4D8 (cyan) with #318EF1
  ...
  return (
    <section className="section-dark min-h-screen flex items-center pt-20 pb-32 overflow-hidden relative">
      <div className="absolute inset-0 opacity-20" style={{
        background: "radial-gradient(ellipse 80% 60% at 70% 50%, rgba(49,142,241,0.3) 0%, transparent 70%)",
      }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-8 items-center">
          <div className="animate-fade-up visible">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white leading-[1.1] mb-6">
              Descubra o seu{" "}
              <span className="text-[#318EF1]">lucro real</span>{" "}
              em cada pedido
            </h1>
            ...
            <div className="flex items-center gap-3">
              <div className="flex -space-x-2">
                {["bg-blue-400", "bg-blue-500", "bg-blue-600", "bg-sky-400"].map((color, i) => (
                  <div key={i} className={`w-9 h-9 rounded-full ${color} border-2 border-[#0A1628] flex items-center justify-center text-white text-xs font-bold`}>
                    {["C", "A", "R", "M"][i]}
                  </div>
                ))}
              </div>
          ...
          <div className="animate-fade-up visible lg:pl-8">
            <div className="relative">
              <div className="absolute -inset-4 rounded-3xl bg-[#318EF1]/10 blur-2xl" />
              <img
                ...
                style={{ boxShadow: "0 0 40px rgba(49,142,241,0.25)" }}
              />
      ...
      <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 1440 100" preserveAspectRatio="none">
        <path d="M0,30 C360,100 1080,0 1440,30 L1440,100 L0,100 Z" fill="#ffffff" />
      </svg>
    </section>
  );
}
...
function WhatIsSection() {
  ...
  return (
    <section id="para-voce" className="section-white relative pt-28 md:pt-36 pb-40 overflow-hidden">
      <div className="container">
          ...
          {tabs.map((tab) => (
            <button key={tab.id} onClick={() => setActiveTab(tab.id)}
              className={`px-5 py-2.5 rounded-full text-sm font-semibold transition-all ${
                activeTab === tab.id
                  ? "bg-[#318EF1] text-white shadow-md"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <p className="text-gray-600 text-lg leading-relaxed mb-8">{content[activeTab].text}</p>
      ...
      <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 1440 110" preserveAspectRatio="none">
        <path d="M0,70 C360,20 1080,120 1440,60 L1440,110 L0,110 Z" fill="#318EF1" />
      </svg>
    </section>
  );
}
...
function HowItWorksSection() {
  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden" style={{ backgroundColor: "#318EF1" }}>
      <div className="container">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-12 animate-fade-up">
          {[
            ...
            <div key={item.step} className="bg-white/15 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
              <div className="flex items-center gap-3 mb-4">
                <span className="text-white/40 text-4xl font-bold leading-none">{item.step}</span>
      ...
      <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 1440 120" preserveAspectRatio="none">
        <path d="M0,40 C480,120 960,0 1440,80 L1440,120 L0,120 Z" fill="oklch(0.97 0.005 240)" />
      </svg>
    </section>
  );
}
  ...
  return (
    <section id="funcionalidades" className="section-light relative py-20 md:py-28 overflow-hidden">
      <div className="container">
            ...
            <div className="space-y-3">
              {analyticsItems.map((item, i) => (
                <div key={i} className="border border-gray-200 rounded-xl overflow-hidden">
                  ...
                  {openAccordion === i && (
                    <div className="px-4 pb-4 text-gray-600 text-sm leading-relaxed">{item.desc}</div>
                  )}
                </div>
              ))}
            </div>
        ...
        {/* Block 2: Controle */}
        <div className="rounded-3xl p-8 md:p-12 grid lg:grid-cols-2 gap-12 items-center" style={{ backgroundColor: "#318EF1" }}>
          <div className="animate-fade-up">
            <img
          ...
          <div className="animate-fade-up">
            ...
            <div className="space-y-3">
              {controlItems.map((item, i) => (
                <div key={i} className="bg-white/15 border border-white/20 rounded-xl overflow-hidden">
                  <button
                    ...
                    <ChevronDown className={`w-5 h-5 text-white/70 transition-transform ${openAccordion === i + 10 ? "rotate-180" : ""}`} />
                  </button>
                  {openAccordion === i + 10 && (
                    <div className="px-4 pb-4 text-white/80 text-sm leading-relaxed">{item.desc}</div>
                  )}
                </div>
              ))}
            </div>
      ...
      <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 1440 110" preserveAspectRatio="none">
        <path d="M0,60 C360,140 1080,0 1440,100 L1440,160 L0,160 Z" fill="oklch(0.16 0.04 240)" />
      </svg>
    </section>
  );
}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          {[
            ...
            <div key={i} className="animate-fade-up">
              <p className="text-4xl md:text-5xl font-bold text-[#318EF1] mb-2">{stat.value}</p>
...
function CTASection() {
  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden" style={{ backgroundColor: "#318EF1" }}>
      ...
      <svg className="absolute -bottom-1 left-0 w-full" viewBox="0 0 1440 130" preserveAspectRatio="none">
        <path d="M0,80 C480,120 960,40 1440,90 L1440,130 L0,130 Z" fill="oklch(1 0 0)" />
      </svg>
    </section>
  );
}
  ...
  return (
    <section className="section-white py-20 md:py-28">
      <div className="container max-w-3xl">
        <div className="text-center mb-12 animate-fade-up">
          <h2 className="text-3xl md:text-4xl font-bold text-[#0A1628]">Perguntas frequentes</h2>
        </div>
            ...
            <div key={i} className="border border-gray-200 rounded-xl overflow-hidden">
              <button
                ...
                <div className={`w-7 h-7 rounded-full flex items-center justify-center flex-shrink-0 transition-colors ${
                  open === i ? "text-white" : "bg-gray-100 text-gray-500"
