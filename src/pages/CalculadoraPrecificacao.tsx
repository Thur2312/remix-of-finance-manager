          ...
          <Card className="border border-blue-200 shadow-lg bg-white">
            <CardContent className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                ...
                {/* Linha 3 */}
                <div className="space-y-1.5">
                  <Label htmlFor="precoCheio" className="text-sm font-medium text-gray-900">
                    Preço Cheio (R$)
                  </Label>
                  <Input
                    id="precoCheio"
                ...
                {/* Linha 5 */}
                <div className="space-y-1.5">
                  <Label className="text-sm font-medium text-gray-900">Preço Promocional</Label>
                  <div className="h-11 flex items-center justify-center px-3 bg-blue-50 border border-blue-200 rounded-md">
