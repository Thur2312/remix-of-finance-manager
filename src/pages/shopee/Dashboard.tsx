...
export function ShopeeDashboardContent() {
  ...
  // lucro_reais (path manual) e valorLiquido = escrow (path sync) são ambos
  // pré-imposto. O imposto por empresa entra no TaxSummaryRow (applyTax por
  // companies.tax_rate/tax_base), fonte única — nunca embutido no card.
  ...
  // Os dois lados têm _cents (sync via computeShopeeFinance, upload manual via
  // calculateResults) — os 3 cards de topo usam formatCents direto.
